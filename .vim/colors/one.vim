...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  " verilog_systemverilog highlighting----------------------------------------{{{
    "call <sid>X('verilogstatement',         s:hue_5,    '', '') 
    "call <sid>X('verilogstatement2',        s:hue_2,    '', 'italic') 
    "call <sid>X('verilogstatement3',        s:hue_3,    '', '') 
    "call <sid>X('verilogstatement4',        s:hue_5,    '', 'italic') 
    "call <sid>X('verilogglobal',            s:hue_3,    '', '')
    "call <sid>X('verilogglobal2',           s:hue_3,  '', '')
    "call <sid>X('verilognumver',            s:hue_5_2,    '', '')
    "call <sid>X('verilogcomment',           s:mono_3,   '', '')
    "call <sid>X('veriloglabel',             s:hue_6,    '', '')
    "call <sid>X('verilogconditional',       s:hue_6_2,  '', '')
    "call <sid>X('verilogconstant',          s:hue_3,    '', 'italic')
    "call <sid>X('verilogoperator',          s:hue_6,    '', '')
  " }}}
...
" verilog highlighting setting
"hi verilogcomment	    guifg=#9d9d9d		
"hi verilognumber	    guifg=#ffc125		
"hi verilogstatement 	guifg=#cd6889			
"hi verilogstatement2	guifg=#87ceeb	gui=italic			
"hi verilogstatement3	guifg=#cd3333  
"hi verilogstatement4    guifg=#cd6889   gui=italic
"hi verilogglobal	    guifg=#cd6889	
"hi verilogglobal2   	guifg=#cd6889	
"hi veriloglabel		    guifg=#fdbd91			
"hi verilogconditional	guifg=#cd6889	
"hi verilogconstant  	guifg=#cd6889	gui=italic
"hi verilogoperator      guifg=#ff7f00 
"gui=italic,bold				
